        ...
        {filteredData.length > 0 ? (
         ...
         <div className={styles.details}>
               <pre >
                ...
                <div className={details_b}>Date:</div> {item.date}<br />
                <div className={details_b}>Time of Arrival:</div> {item.arrivalTime}<br />
                <div className={details_b}>Time Out:</div> {item.timeOut}
              </pre>
         </div>
