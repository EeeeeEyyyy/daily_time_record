      ...
      <div className={styles.trainees_m}style={{ marginTop: '1rem' }}>
        ...
        {filteredData.length > 0 ? (
         ...
         <div className={styles.details}>
               <pre >
                <div className={styles.details_b}>Name:</div> {item.name}<br />
                <div className={Time Out:details_b}>Date:</div> {item.date}<br />
                <div className={Time Out:details_b}>Time of Arrival:</div> {item.arrivalTime}<br />
                <div className={Time Out:details_b}>Time Out:</div> {item.timeOut}
              </pre>
         </div>
             <div className={styles.button_e_d}> <button onClick={() => handleEdit(index)}>Edit</button>
