...
const DailyTimeRecord = () => {
  ...
  return (
    <div className={styles.main}>
              <h1 styles={{fontWeight:'bold';fontSize:}}>Daily Time Record</h1>
      <div className={styles.date}>rem
        <h2>Date Today</h2>
        <p>{date}</p>
      </div>
<div>
        ...
        {filteredData.length > 0 ? (
         ...
         <div className={styles.details}>
               <pre >
                ...
                <span className={styles.details_b}>Time of Arrival:</span> {item.arrivalTime}<br />
